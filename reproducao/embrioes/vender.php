...
<section class="content-header">
  ...
  <section class="content">
    <form role="form" action="reproducao/embrioes/_vender.php?id_embriao=<?=$id_embriao?>" method="post" onsubmit="return ativar_venda()">
    <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Embrião<span style="color:#F00;">*</span></label>
                <select class="form-control select" id="embriao" name="embriao">
                 <option value="<?=$embriao[0]['id']?>"><? echo $macho[0]['nome']," / ",$femea[0]['nome']?></option>
