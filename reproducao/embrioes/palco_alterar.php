...
<div class="col-md-12">
  ...
  <div class="box box-danger">
    <div class="box-header with-border">
      <h3 class="box-title">Alterar quantidade de embriões</h3>
    </div>
    <!-- /.box-header -->

    <!-- form start -->
      <div class="box-body">
        <form method="post" action="reproducao/embrioes/_alterar.php?id_embriao=<?=$id_embriao?>">
        ...
        <div class="form-group">
          <button type="button" class="btn btn-danger" style="margin-right:40%;" onclick="fechar_alterar()">Fechar</button>
