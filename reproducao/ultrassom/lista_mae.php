...
foreach ($animal as $animais) {
  ...
  ?>
  <a href="javascript:linkar_animal_ultrassom('<?=$animais['id']?>', 0);" style="color:#2d2c2c;">
...
foreach ($animal as $animais) {
  ...
  ?>
  <a href="javascript:linkar_animal_ultrassom('<?=$animais['id']?>', 1);" style="color:#2d2c2c;">
...
<? } ?>
  ...
  <a href="javascript:fechar_lista_mae_ultrassom();" style="color:#2d2c2c;">
