...
foreach (($animal ?: []) as $animais) {
  ...
  ?>
  <button type="button" class="animal-search-result" onclick="linkar_mae(this.getAttribute('data-nome'))" data-nome="<?=htmlspecialchars($animais['nome'], ENT_QUOTES, 'UTF-8')?>" style="display:block; width:100%; text-align:left; border:0; border-bottom:1px solid #eee; color:#2d2c2c; padding:8px; overflow-wrap:anywhere;">
