...
$pesagemAvaliacao = $lerDataAvaliacao($animal[0]['data2'] ?? null);
$data_nascimento = $nascimentoAvaliacao ? $nascimentoAvaliacao->format('d/m/Y') : '';
$data_apartacao = $pesagemAvaliacao ? $pesagemAvaliacao->format('d/m/Y') : '';
$dias_apartacao = null;
$gmd = null;
if ($nascimentoAvaliacao && $pesagemAvaliacao && $pesagemAvaliacao > $nascimentoAvaliacao) {
  $dias_apartacao = (int)$nascimentoAvaliacao->diff($pesagemAvaliacao)->days;
  if (is_numeric($animal[0]['peso2'] ?? null) && is_numeric($animal[0]['peso_inicial'] ?? null)) {
...
<form method="post" action="animal/avaliacao/_peso_apartacao.php?id_animal=<?=$id_animal?>" onsubmit="return ativar_apartacao()">
      ...
      <div class="col-md-6">
        ...
        if($animal[0]['sexo'] == 'Fêmea'){
          if($dias_apartacao !== null && $dias_apartacao <= 90) {
            ?>
            <div class="col-md-12">
...
<form name="form1" method="post" action="animal/avaliacao/_avaliar.php?id_animal=<?=$id_animal?>&avaliacao=1" onsubmit="return ativar_avaliacao()">
        <div class="col-md-12">
          ...
          <? if(($ava1[0]['tamanho'] ?? null) == 5){ ?> <input type="radio" id="tamanho1" name="tamanho" value="5" checked="checked"> <? }else{?> <input type="radio" id="tamanho1" name="tamanho" value="5"><? } ?>
          Tipo 5 (Muito bom) &nbsp;&nbsp;&nbsp;
          <? if(($ava1[0]['tamanho'] ?? null) == 4){ ?> <input type="radio" id="tamanho2" name="tamanho" value="4" checked="checked"> <? }else{?> <input type="radio" id="tamanho2" name="tamanho" value="4"><? } ?>Tipo 4 (Bom)&nbsp;&nbsp;&nbsp;
          <? if(($ava1[0]['tamanho'] ?? null) == 3){ ?> <input type="radio" id="tamanho3" name="tamanho" value="3" checked="checked"> <? }else{?> <input type="radio" id="tamanho3" name="tamanho" value="3"><? } ?>Tipo 3 (Ruim)&nbsp;&nbsp;&nbsp;
          <? if(($ava1[0]['tamanho'] ?? null) == 2){ ?> <input type="radio" id="tamanho4" name="tamanho" value="2" checked="checked"> <? }else{?> <input type="radio" id="tamanho4" name="tamanho" value="2"><? } ?>Tipo 2 (Descarte)&nbsp;&nbsp;&nbsp;
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['cabeca'] ?? null) == 5){ ?><input type="radio" id="cabeca1" name="cabeca" value="5" checked="checked"> <? }else{?> <input type="radio" id="cabeca1" name="cabeca" value="5"><? } ?>Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['cabeca'] ?? null) == 4){ ?><input type="radio" id="cabeca2" name="cabeca" value="4" checked="checked"> <? }else{?> <input type="radio" id="cabeca2" name="cabeca" value="4"><? } ?>Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['cabeca'] ?? null) == 3){ ?><input type="radio" id="cabeca3" name="cabeca" value="3" checked="checked"> <? }else{?> <input type="radio" id="cabeca3" name="cabeca" value="3"><? } ?>Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['cabeca'] ?? null) == 2){ ?><input type="radio" id="cabeca4" name="cabeca" value="2" checked="checked"> <? }else{?> <input type="radio" id="cabeca4" name="cabeca" value="2"><? } ?>Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['pescoco'] ?? null) == 5){ ?><input type="radio" id="pescoco1" name="pescoco" value="5" checked="checked"><? }else{?><input type="radio" id="pescoco1" name="pescoco" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['pescoco'] ?? null) == 4){ ?><input type="radio" id="pescoco2" name="pescoco" value="4" checked="checked"><? }else{?><input type="radio" id="pescoco2" name="pescoco" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['pescoco'] ?? null) == 3){ ?><input type="radio" id="pescoco3" name="pescoco" value="3" checked="checked"><? }else{?><input type="radio" id="pescoco3" name="pescoco" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['pescoco'] ?? null) == 2){ ?><input type="radio" id="pescoco4" name="pescoco" value="2" checked="checked"><? }else{?><input type="radio" id="pescoco4" name="pescoco" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['quarto_anterior'] ?? null) == 5){ ?><input type="radio" id="quarto_anterior1" name="quarto_anterior" value="5" checked="checked"><? }else{?><input type="radio" id="quarto_anterior1" name="quarto_anterior" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['quarto_anterior'] ?? null) == 4){ ?><input type="radio" id="quarto_anterior2" name="quarto_anterior" value="4" checked="checked"><? }else{?><input type="radio" id="quarto_anterior2" name="quarto_anterior" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['quarto_anterior'] ?? null) == 3){ ?><input type="radio" id="quarto_anterior3" name="quarto_anterior" value="3" checked="checked"><? }else{?><input type="radio" id="quarto_anterior3" name="quarto_anterior" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['quarto_anterior'] ?? null) == 2){ ?><input type="radio" id="quarto_anterior4" name="quarto_anterior" value="2" checked="checked"><? }else{?><input type="radio" id="quarto_anterior4" name="quarto_anterior" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['barril'] ?? null) == 5){ ?><input type="radio" id="barril1" name="barril" value="5" checked="checked"><? }else{?><input type="radio" id="barril1" name="barril" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['barril'] ?? null) == 4){ ?><input type="radio" id="barril2" name="barril" value="4" checked="checked"><? }else{?><input type="radio" id="barril2" name="barril" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['barril'] ?? null) == 3){ ?><input type="radio" id="barril3" name="barril" value="3" checked="checked"><? }else{?><input type="radio" id="barril3" name="barril" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['barril'] ?? null) == 2){ ?><input type="radio" id="barril4" name="barril" value="2" checked="checked"><? }else{?><input type="radio" id="barril4" name="barril" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['quarto_posterior'] ?? null) == 5){ ?><input type="radio" id="quarto_posterior1" name="quarto_posterior" value="5" checked="checked"><? }else{?><input type="radio" id="quarto_posterior1" name="quarto_posterior" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['quarto_posterior'] ?? null) == 4){ ?><input type="radio" id="quarto_posterior2" name="quarto_posterior" value="4" checked="checked"><? }else{?><input type="radio" id="quarto_posterior2" name="quarto_posterior" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['quarto_posterior'] ?? null) == 3){ ?><input type="radio" id="quarto_posterior3" name="quarto_posterior" value="3" checked="checked"><? }else{?><input type="radio" id="quarto_posterior3" name="quarto_posterior" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['quarto_posterior'] ?? null) == 2){ ?><input type="radio" id="quarto_posterior4" name="quarto_posterior" value="2" checked="checked"><? }else{?><input type="radio" id="quarto_posterior4" name="quarto_posterior" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['comprimento'] ?? null) == 5){ ?><input type="radio" id="comprimento1" name="comprimento" value="5" checked="checked"><? }else{?><input type="radio" id="comprimento1" name="comprimento" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['comprimento'] ?? null) == 4){ ?><input type="radio" id="comprimento2" name="comprimento" value="4" checked="checked"><? }else{?><input type="radio" id="comprimento2" name="comprimento" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['comprimento'] ?? null) == 3){ ?><input type="radio" id="comprimento3" name="comprimento" value="3" checked="checked"><? }else{?><input type="radio" id="comprimento3" name="comprimento" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['comprimento'] ?? null) == 2){ ?><input type="radio" id="comprimento4" name="comprimento" value="2" checked="checked"><? }else{?><input type="radio" id="comprimento4" name="comprimento" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['orgao'] ?? null) == 5){ ?><input type="radio" id="orgao1" name="orgao" value="5" checked="checked"><? }else{?><input type="radio" id="orgao1" name="orgao" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['orgao'] ?? null) == 4){ ?><input type="radio" id="orgao2" name="orgao" value="4" checked="checked"><? }else{?><input type="radio" id="orgao2" name="orgao" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['orgao'] ?? null) == 3){ ?><input type="radio" id="orgao3" name="orgao" value="3" checked="checked"><? }else{?><input type="radio" id="orgao3" name="orgao" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['orgao'] ?? null) == 2){ ?><input type="radio" id="orgao4" name="orgao" value="2" checked="checked"><? }else{?><input type="radio" id="orgao4" name="orgao" value="2"><? } ?>Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['distribuicao'] ?? null) == 5){ ?><input type="radio" id="distribuicao1" name="distribuicao" value="5" checked="checked"><? }else{?><input type="radio" id="distribuicao1" name="distribuicao" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['distribuicao'] ?? null) == 4){ ?><input type="radio" id="distribuicao2" name="distribuicao" value="4" checked="checked"><? }else{?><input type="radio" id="distribuicao2" name="distribuicao" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['distribuicao'] ?? null) == 3){ ?><input type="radio" id="distribuicao3" name="distribuicao" value="3" checked="checked"><? }else{?><input type="radio" id="distribuicao3" name="distribuicao" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['distribuicao'] ?? null) == 2){ ?><input type="radio" id="distribuicao4" name="distribuicao" value="2" checked="checked"><? }else{?><input type="radio" id="distribuicao4" name="distribuicao" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['cobertura'] ?? null) == 5){ ?><input type="radio" id="cobertura1" name="cobertura" value="5" checked="checked"><? }else{?><input type="radio" id="cobertura1" name="cobertura" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['cobertura'] ?? null) == 4){ ?><input type="radio" id="cobertura2" name="cobertura" value="4" checked="checked"><? }else{?><input type="radio" id="cobertura2" name="cobertura" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['cobertura'] ?? null) == 3){ ?><input type="radio" id="cobertura3" name="cobertura" value="3" checked="checked"><? }else{?><input type="radio" id="cobertura3" name="cobertura" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['cobertura'] ?? null) == 2){ ?><input type="radio" id="cobertura4" name="cobertura" value="2" checked="checked"><? }else{?><input type="radio" id="cobertura4" name="cobertura" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
...
<div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body">
        <label for="exampleInputPassword1">Selecionar tipo</label><br/>
        <? if(($ava1[0]['cor'] ?? null) == 5){ ?><input type="radio" id="cor1" name="cor" value="5" checked="checked"><? }else{?><input type="radio" id="cor1" name="cor" value="5"><? } ?> Tipo 5 (Muito bom)<br/>
        <? if(($ava1[0]['cor'] ?? null) == 4){ ?><input type="radio" id="cor2" name="cor" value="4" checked="checked"><? }else{?><input type="radio" id="cor2" name="cor" value="4"><? } ?> Tipo 4 (Bom)<br/>
        <? if(($ava1[0]['cor'] ?? null) == 3){ ?><input type="radio" id="cor3" name="cor" value="3" checked="checked"><? }else{?><input type="radio" id="cor3" name="cor" value="3"><? } ?> Tipo 3 (Ruim)<br/>
        <? if(($ava1[0]['cor'] ?? null) == 2){ ?><input type="radio" id="cor4" name="cor" value="2" checked="checked"><? }else{?><input type="radio" id="cor4" name="cor" value="2"><? } ?> Tipo 2 (Descarte)<br/>
      </div>
    </div>
</div>
