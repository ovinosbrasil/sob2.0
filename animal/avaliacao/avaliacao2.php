...
<div class="col-md-12">
    <div class="box">
      ...
      <div class="box-body">
<form method="post" action="animal/avaliacao/_peso_adulto.php?id_animal=<?=$id_animal?>" onsubmit="return ativar_apartacao()">
        <div class="col-md-4">
            <div class="col-md-6">
              ...
              <div class="form-group" style="margin-top:3%;">
                <label for="exampleInputPassword1">Data pesagem<span style="color:#F00;">*</span></label>
                <input type="text" class="form-control" id="data_adulto" name="data_adulto" value="<?=$data_adulto?>">
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group" style="margin-top:3%;">
                <label for="exampleInputPassword1">Peso adulto(kg)<span style="color:#F00;">*</span></label>
                <input type="text" class="form-control" id="peso_adulto" name="peso_adulto" value="<?=$animal[0]['peso3']*100?>">
              </div>
            </div>
      ...
      <div class="col-md-6">
        ...
        if($animal[0]['sexo'] == 'Fêmea'){
          ...
          if($dias_adulto > 90 && $dias_adulto <= 210) {
            ?>
            <div class="col-md-12">
          ...
          if($dias_adulto > 210 && $dias_adulto <= 365) {
            ?>
            <div class="col-md-12">
...
<form name="form1" method="post" action="animal/avaliacao/_avaliar.php?id_animal=<?=$id_animal?>&avaliacao=2" onsubmit="return ativar_avaliacao()">
        <div class="col-md-12">
          <div class="form-group" style="margin-top:3%;">
