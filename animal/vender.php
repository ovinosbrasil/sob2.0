...
<div class="col-md-3">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <? if($animal[0]['status'] == 2){ ?><button type="button" class="btn btn-primary" style="margin-top:6%; width:100%;" onclick="desfazer_venda()">Desfazer venda</button> <? } ?>
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <select class="form-control select" id="forma" name="forma">
        <? if($venda[0]['forma_de_pagamento']){ ?><option value="<?=$venda[0]['forma_de_pagamento']?>"><?=$venda[0]['forma_de_pagamento']?></option> <? }else{?> <option >Selecionar tipo</option><? } ?>
        <option></option>
