...
$valor = $_POST['valor_faturamento'];
$valor = str_replace("," , "" , $valor);
$descricao = $_POST['descricao_faturamento'];
$status = $_POST['status_faturamento'];
$mes = date('m');
$ano = date('Y');
$parcelas = $_POST['parcelas_faturamento'];
$forma = $_POST['forma_faturamento'];
